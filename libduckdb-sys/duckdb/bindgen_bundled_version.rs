...
extern "C" {
    ...
    #[doc = ""]
    #[doc = "Usually used for developing C extensions that must return this for a compatibility check."]
...
extern "C" {
    ...
    #[doc = " returns: The text value at the specified location as a null-terminated string, or nullptr if the value cannot be"]
    #[doc = "converted. The result must be freed with `duckdb_free`."]
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = "If the conversion fails because the double value is too big, or the width/scale are invalid the result will be 0."]
    #[doc = ""]
    #[doc = " val: The double value."]
    #[doc = " returns: The converted `duckdb_decimal` element."]
