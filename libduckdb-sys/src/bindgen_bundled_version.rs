...
extern "C" {
    pub fn malloc_type_calloc(count: usize, size: usize, type_id: malloc_type_id_t) -> *mut ::std::os::raw::c_void;
}
extern "C" {
...
extern "C" {
    pub fn malloc_type_zone_free(zone: *mut malloc_zone_t, ptr: *mut ::std::os::raw::c_void, type_id: malloc_type_id_t);
}
extern "C" {
