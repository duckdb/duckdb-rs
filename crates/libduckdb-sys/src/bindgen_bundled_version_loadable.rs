...
pub const DUCKDB_EXTENSION_API_VERSION_MAJOR: u32 = 1;
pub const DUCKDB_EXTENSION_API_VERSION_MINOR: u32 = 2;
pub const DUCKDB_EXTENSION_API_VERSION_PATCH: u32 = 0;
...
#[test]
fn bindgen_test_layout_duckdb_timestamp_s() {
    const UNINIT: ::std::mem::MaybeUninit<duckdb_timestamp_s> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<duckdb_timestamp_s>(),
        8usize,
        concat!("Size of: ", stringify!(duckdb_timestamp_s))
    );
    assert_eq!(
        ::std::mem::align_of::<duckdb_timestamp_s>(),
        8usize,
        concat!("Alignment of ", stringify!(duckdb_timestamp_s))
    );
    assert_eq!(
...
#[test]
fn bindgen_test_layout_duckdb_timestamp_ms() {
    const UNINIT: ::std::mem::MaybeUninit<duckdb_timestamp_ms> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<duckdb_timestamp_ms>(),
        8usize,
        concat!("Size of: ", stringify!(duckdb_timestamp_ms))
    );
    assert_eq!(
        ::std::mem::align_of::<duckdb_timestamp_ms>(),
        8usize,
        concat!("Alignment of ", stringify!(duckdb_timestamp_ms))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).millis) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(duckdb_timestamp_ms),
            "::",
            stringify!(millis)
        )
    );
...
#[test]
fn bindgen_test_layout_duckdb_timestamp_ns() {
    const UNINIT: ::std::mem::MaybeUninit<duckdb_timestamp_ns> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<duckdb_timestamp_ns>(),
        8usize,
        concat!("Size of: ", stringify!(duckdb_timestamp_ns))
    );
    assert_eq!(
        ::std::mem::align_of::<duckdb_timestamp_ns>(),
        8usize,
        concat!("Alignment of ", stringify!(duckdb_timestamp_ns))
    );
    assert_eq!(
...
#[test]
fn bindgen_test_layout_duckdb_bit() {
    const UNINIT: ::std::mem::MaybeUninit<duckdb_bit> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<duckdb_bit>(),
        16usize,
        concat!("Size of: ", stringify!(duckdb_bit))
    );
    assert_eq!(
        ::std::mem::align_of::<duckdb_bit>(),
        8usize,
        concat!("Alignment of ", stringify!(duckdb_bit))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).data) as usize - ptr as usize },
        0usize,
        concat!("Offset of field: ", stringify!(duckdb_bit), "::", stringify!(data))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).size) as usize - ptr as usize },
        8usize,
        concat!("Offset of field: ", stringify!(duckdb_bit), "::", stringify!(size))
    );
}
...
#[test]
fn bindgen_test_layout_duckdb_varint() {
    const UNINIT: ::std::mem::MaybeUninit<duckdb_varint> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<duckdb_varint>(),
        24usize,
        concat!("Size of: ", stringify!(duckdb_varint))
    );
    assert_eq!(
        ::std::mem::align_of::<duckdb_varint>(),
        8usize,
        concat!("Alignment of ", stringify!(duckdb_varint))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).data) as usize - ptr as usize },
        0usize,
        concat!("Offset of field: ", stringify!(duckdb_varint), "::", stringify!(data))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).size) as usize - ptr as usize },
        8usize,
        concat!("Offset of field: ", stringify!(duckdb_varint), "::", stringify!(size))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).is_negative) as usize - ptr as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(duckdb_varint),
            "::",
            stringify!(is_negative)
        )
    );
}
...
#[test]
fn bindgen_test_layout__duckdb_instance_cache() {
    const UNINIT: ::std::mem::MaybeUninit<_duckdb_instance_cache> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<_duckdb_instance_cache>(),
        8usize,
        concat!("Size of: ", stringify!(_duckdb_instance_cache))
    );
    assert_eq!(
        ::std::mem::align_of::<_duckdb_instance_cache>(),
        8usize,
        concat!("Alignment of ", stringify!(_duckdb_instance_cache))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).internal_ptr) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(_duckdb_instance_cache),
            "::",
            stringify!(internal_ptr)
        )
    );
...
#[test]
fn bindgen_test_layout_duckdb_ext_api_v1() {
    const UNINIT: ::std::mem::MaybeUninit<duckdb_ext_api_v1> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<duckdb_ext_api_v1>(),
        2856usize,
        concat!("Size of: ", stringify!(duckdb_ext_api_v1))
    );
    assert_eq!(
        ::std::mem::align_of::<duckdb_ext_api_v1>(),
        8usize,
        concat!("Alignment of ", stringify!(duckdb_ext_api_v1))
    );
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).duckdb_param_logical_type) as usize - ptr as usize },
        416usize,
        concat!(
            "Offset of field: ",
            stringify!(duckdb_ext_api_v1),
            "::",
            stringify!(duckdb_param_logical_type)
        )
    );
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).duckdb_create_varint) as usize - ptr as usize },
        912usize,
        concat!(
            "Offset of field: ",
            stringify!(duckdb_ext_api_v1),
            "::",
            stringify!(duckdb_create_varint)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).duckdb_create_decimal) as usize - ptr as usize },
        920usize,
        concat!(
            "Offset of field: ",
            stringify!(duckdb_ext_api_v1),
            "::",
            stringify!(duckdb_create_decimal)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).duckdb_create_bit) as usize - ptr as usize },
        928usize,
        concat!(
            "Offset of field: ",
            stringify!(duckdb_ext_api_v1),
            "::",
            stringify!(duckdb_create_bit)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).duckdb_create_uuid) as usize - ptr as usize },
        936usize,
        concat!(
            "Offset of field: ",
            stringify!(duckdb_ext_api_v1),
            "::",
            stringify!(duckdb_create_uuid)
        )
    );
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).duckdb_get_varint) as usize - ptr as usize },
        1104usize,
        concat!(
            "Offset of field: ",
            stringify!(duckdb_ext_api_v1),
            "::",
            stringify!(duckdb_get_varint)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).duckdb_get_decimal) as usize - ptr as usize },
        1112usize,
        concat!(
            "Offset of field: ",
            stringify!(duckdb_ext_api_v1),
            "::",
            stringify!(duckdb_get_decimal)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).duckdb_get_bit) as usize - ptr as usize },
        1120usize,
        concat!(
            "Offset of field: ",
            stringify!(duckdb_ext_api_v1),
            "::",
            stringify!(duckdb_get_bit)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).duckdb_get_uuid) as usize - ptr as usize },
        1128usize,
        concat!(
            "Offset of field: ",
            stringify!(duckdb_ext_api_v1),
            "::",
            stringify!(duckdb_get_uuid)
        )
    );
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).duckdb_is_null_value) as usize - ptr as usize },
        1192usize,
        concat!(
            "Offset of field: ",
            stringify!(duckdb_ext_api_v1),
            "::",
            stringify!(duckdb_is_null_value)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).duckdb_create_null_value) as usize - ptr as usize },
        1200usize,
        concat!(
            "Offset of field: ",
            stringify!(duckdb_ext_api_v1),
            "::",
            stringify!(duckdb_create_null_value)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).duckdb_get_list_size) as usize - ptr as usize },
        1208usize,
        concat!(
            "Offset of field: ",
            stringify!(duckdb_ext_api_v1),
            "::",
            stringify!(duckdb_get_list_size)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).duckdb_get_list_child) as usize - ptr as usize },
        1216usize,
        concat!(
            "Offset of field: ",
            stringify!(duckdb_ext_api_v1),
            "::",
            stringify!(duckdb_get_list_child)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).duckdb_create_enum_value) as usize - ptr as usize },
        1224usize,
        concat!(
            "Offset of field: ",
            stringify!(duckdb_ext_api_v1),
            "::",
            stringify!(duckdb_create_enum_value)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).duckdb_get_enum_value) as usize - ptr as usize },
        1232usize,
        concat!(
            "Offset of field: ",
            stringify!(duckdb_ext_api_v1),
            "::",
            stringify!(duckdb_get_enum_value)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).duckdb_get_struct_child) as usize - ptr as usize },
        1240usize,
        concat!(
            "Offset of field: ",
            stringify!(duckdb_ext_api_v1),
            "::",
            stringify!(duckdb_get_struct_child)
        )
    );
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).duckdb_appender_create_ext) as usize - ptr as usize },
        2256usize,
        concat!(
            "Offset of field: ",
            stringify!(duckdb_ext_api_v1),
            "::",
            stringify!(duckdb_appender_create_ext)
        )
    );
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).duckdb_appender_add_column) as usize - ptr as usize },
        2312usize,
        concat!(
            "Offset of field: ",
            stringify!(duckdb_ext_api_v1),
            "::",
            stringify!(duckdb_appender_add_column)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).duckdb_appender_clear_columns) as usize - ptr as usize },
        2320usize,
        concat!(
            "Offset of field: ",
            stringify!(duckdb_ext_api_v1),
            "::",
            stringify!(duckdb_appender_clear_columns)
        )
    );
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).duckdb_table_description_create_ext) as usize - ptr as usize },
        2344usize,
        concat!(
            "Offset of field: ",
            stringify!(duckdb_ext_api_v1),
            "::",
            stringify!(duckdb_table_description_create_ext)
        )
    );
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).duckdb_table_description_get_column_name) as usize - ptr as usize },
        2376usize,
        concat!(
            "Offset of field: ",
            stringify!(duckdb_ext_api_v1),
            "::",
            stringify!(duckdb_table_description_get_column_name)
        )
    );
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).duckdb_is_finite_timestamp_s) as usize - ptr as usize },
        2552usize,
        concat!(
            "Offset of field: ",
            stringify!(duckdb_ext_api_v1),
            "::",
            stringify!(duckdb_is_finite_timestamp_s)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).duckdb_is_finite_timestamp_ms) as usize - ptr as usize },
        2560usize,
        concat!(
            "Offset of field: ",
            stringify!(duckdb_ext_api_v1),
            "::",
            stringify!(duckdb_is_finite_timestamp_ms)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).duckdb_is_finite_timestamp_ns) as usize - ptr as usize },
        2568usize,
        concat!(
            "Offset of field: ",
            stringify!(duckdb_ext_api_v1),
            "::",
            stringify!(duckdb_is_finite_timestamp_ns)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).duckdb_create_timestamp_tz) as usize - ptr as usize },
        2576usize,
        concat!(
            "Offset of field: ",
            stringify!(duckdb_ext_api_v1),
            "::",
            stringify!(duckdb_create_timestamp_tz)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).duckdb_create_timestamp_s) as usize - ptr as usize },
        2584usize,
        concat!(
            "Offset of field: ",
            stringify!(duckdb_ext_api_v1),
            "::",
            stringify!(duckdb_create_timestamp_s)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).duckdb_create_timestamp_ms) as usize - ptr as usize },
        2592usize,
        concat!(
            "Offset of field: ",
            stringify!(duckdb_ext_api_v1),
            "::",
            stringify!(duckdb_create_timestamp_ms)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).duckdb_create_timestamp_ns) as usize - ptr as usize },
        2600usize,
        concat!(
            "Offset of field: ",
            stringify!(duckdb_ext_api_v1),
            "::",
            stringify!(duckdb_create_timestamp_ns)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).duckdb_get_timestamp_tz) as usize - ptr as usize },
        2608usize,
        concat!(
            "Offset of field: ",
            stringify!(duckdb_ext_api_v1),
            "::",
            stringify!(duckdb_get_timestamp_tz)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).duckdb_get_timestamp_s) as usize - ptr as usize },
        2616usize,
        concat!(
            "Offset of field: ",
            stringify!(duckdb_ext_api_v1),
            "::",
            stringify!(duckdb_get_timestamp_s)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).duckdb_get_timestamp_ms) as usize - ptr as usize },
        2624usize,
        concat!(
            "Offset of field: ",
            stringify!(duckdb_ext_api_v1),
            "::",
            stringify!(duckdb_get_timestamp_ms)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).duckdb_get_timestamp_ns) as usize - ptr as usize },
        2632usize,
        concat!(
            "Offset of field: ",
            stringify!(duckdb_ext_api_v1),
            "::",
            stringify!(duckdb_get_timestamp_ns)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).duckdb_append_value) as usize - ptr as usize },
        2640usize,
        concat!(
            "Offset of field: ",
            stringify!(duckdb_ext_api_v1),
            "::",
            stringify!(duckdb_append_value)
        )
    );
    assert_eq!(
